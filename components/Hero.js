		...
		<div className="my-48 mx-auto max-w-7xl px-4 sm:mt-24 md:mt-72 text-center">
			<h1 className="font-extrabold text-gray-900">
				<p className="text-4xl font-bold tracking-tight sm:text-6xl">
					Shopify + Next.js + Tailwindcss Theme
				</p>
			...
			<h2 className="mt-3 max-w-md mx-auto text-gray-500 sm:text-lg md:md-5 md:text-xl md:max-x-3xl">
				Build the eCommerce Revolution
			</h2>
			<div className="mt-5 max-w-md mx-auto flex justify-center items-center md:mt-8">
				<Link legacyBehavior href="#">
					<a className="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wider text-white bg-black rounded-full py-3 border-transparent rounded-md text-white bg-indigo-500 hover:bg-indigo-600 bg-gray-900 hover:bg-gray-800">
						Enroll Now
					</a>
				</Link>
				<Link legacyBehavior href="#">
